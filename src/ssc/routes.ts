...
import {
  ...
  handleSsc_invoke_create_rift_lobby,
  handleSsc_invoke_leave_player_lobby,
  handleSsc_invoke_load_gameplay_config,
  handleSsc_invoke_lock_rift_lobby_loadout,
  handleSsc_invoke_perks_get_all_pages,
  handleSsc_invoke_start_rift_node,
  handleSsc_invoke_switch_rift_chapters,
  perks_set_page,
...
//RIFTS
sscRouter.put("/ssc/invoke/create_rift_lobby", async (req: Request, res: Response) => {
  await handleSsc_invoke_create_rift_lobby(req, res);
});

sscRouter.put("/ssc/invoke/switch_rift_chapters", async (req: Request, res: Response) => {
  await handleSsc_invoke_switch_rift_chapters(req, res);
});

sscRouter.put("/ssc/invoke/lock_rift_lobby_loadout", async (req: Request, res: Response) => {
  await handleSsc_invoke_lock_rift_lobby_loadout(req, res);
});

sscRouter.put("/ssc/invoke/start_rift_node", async (req: Request, res: Response) => {
  await handleSsc_invoke_start_rift_node(req, res);
});

sscRouter.get("/ssc/invoke/load_gameplay_config", async (req: Request, res: Response) => {
  await handleSsc_invoke_load_gameplay_config(req, res);
});
