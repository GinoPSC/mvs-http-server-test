/* added Map list with code and name
  "M000",//Training room - old
  "M001",//BatCave 2v2
  "M001_V2",//BatCave 1v1
  "M002_V2",//Tree Fort 1v1
  "M002_V3",//Tree Fort Night
  "M003_V1",//Thropy's edge 1v1
  "M003_V3",//Thropy's edge 2v2
  "M003_V5",//Thropy's edge 3
  "M006_V2",//Scooby's Haunted Mansion 2v2
  "M006_V3",//Scooby's Haunted Mansion 1v1
  "M008_V2",//Throne room
  "M009_V1",//Cromulons 2v2
  "M009_V2",//Cromulons 1v1
  "M011_V3",//Sky arena - Platform
  "M011_V4",//Sky arena
  "M012_V2",//Teen Titans Tower 1v1
  "M013_V2",//Doesnt work
  "M014_V2",//Midnight Showing 1v1
  "M015_V1",//TownsVille
  "M015_V2".//TownsVille - Fire
  "M016_V2",//Dexter's Lab 2
  "M017_V1",//Samurai Jack Map - Past
  "M017_V2",//Samurai Jack Map - Future
  "M018_V2",//Sweet Kingdom 1v1
  "M019",//Acme Labs
  "M020",//Cat Concerto
*/

export const mapsCasual = [
  "M000"
];
...
//ARRAY SHUFFLE
let map_counter = maps1v1.length;
...
//New random map method - only for 1v1
export function getRandomMap1v1(): string {//test
  //const randomIndex = Math.floor(Math.random() * maps1v1.length);
  if (map_counter == maps1v1.length){
    map_counter = 0;
    shuffle(maps1v1);
  }
  const num = map_counter;
  map_counter++;
  return maps1v1[num];
}

//OLD random map method
export function getRandomMapCasual(): string {
  const randomIndex = Math.floor(Math.random() * mapsCasual.length);
  return mapsCasual[randomIndex];
}
